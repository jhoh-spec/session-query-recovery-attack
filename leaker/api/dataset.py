...
class KeywordQueryLog(Data):
    ...
    def keywords(self, user_id: str = None, remove_endstates: bool = False) -> Set[str]:
        """Returns the set of all queries in this query log.
        If remove_endstates, removes keywords that result in end states in the transition matrix of the individual
        query sequences."""
        return set(self.keywords_list(user_id, remove_endstates))
